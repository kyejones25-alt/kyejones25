# Hi, I'm Kye Jones
**Data Analyst | MS in IT Management (Data Analytics, 4.0 GPA) | CWU**

I build forecasting models, dashboards, and econometric studies that turn raw data into business decisions.
...
|---|---|---|
| **Cass Freight Index Forecasting** | R, ARIMA, ETS, STL | Time-series forecasting on 33 years of North American freight data |
| **ESG & Board Gender Diversity** | R, OLS Regression | Regression analysis on 534 S&P 500 companies |
| **CA Housing Price Prediction** | Python, Scikit-learn | Gradient Boosting model achieving R² = 0.82 |
| **Global Superstore Dashboard** | Tableau | Interactive dashboard analyzing $12.6M in retail sales |
| **Six Nations Rugby Performance Analysis** | SQL, Power BI | End-to-end pipeline across 390+ matches and 2,700+ international results |
...
|---|---|---|
| Six Nations Results (2000–2025) | 390 matches | Kaggle |
| International Rugby Results (1871–2024) | 2,783 matches | Kaggle |
...
## Education
- MS, Information Technology & Administrative Management — CWU, 4.0 GPA (2024–2025)
- BS, Economics — Business Forecasting — CWU, 3.87 GPA (2020–2024)

---

## Connect
- Email: kyejones25@gmail.com
- LinkedIn: [linkedin.com/in/kye-jones-1744a3225](https://linkedin.com/in/kye-jones-1744a3225)
